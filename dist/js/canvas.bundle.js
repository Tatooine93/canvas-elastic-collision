    ...
    value: function update(particles) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["distance"])(this.x, this.y, particle.x, particle.y) - this.radius * 2 < 0) {
            Object(_utils__WEBPACK_IMPORTED_MODULE_0__["resolveCollision"])(this, particle);
          }
        }
      } catch (err) {
        _iterator.e(err);
